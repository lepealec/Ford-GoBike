...
net=F
go=F
if ((!("FGB.csv" %in% list.files()) | go) & net){
  ...
  ### Load data
  added=c()
  for (yrmo in c(seq(201801,201812),201901,201902,201903)){
    #yrmo=201812
    print(yrmo)
    ...
    if (!(csv %in% list.files()) & url.exists(link)){
      print("Downloading")
      added=paste(added,csv)
  ...
  Mar2019=fread("201903-fordgobike-tripdata.csv")
