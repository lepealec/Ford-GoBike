...
url=paste0("https://gbfs.fordgobike.com/gbfs/en/station_status.json")
  fn=paste0(paste0(strsplit(as.character(Sys.time()),split=" ")[[1]][1]," ",
                   paste0(strsplit(strsplit(as.character(Sys.time()),split=" ")[[1]][2],split=":")[[1]],collapse="."),collapse=" ")
            ,".csv")
  fn2=strsplit(fn," ")[[1]][2]
